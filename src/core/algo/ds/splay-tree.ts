...
function* run(input: unknown): Generator<VisualFrame, void, unknown> {
    ...
    yield {
        ...
        edges: edges.map((e) => ({ ...e })),
        description: `Splay tree – accessing ${access} splays it to the root.`,
        codeLineNumber: 0,
        layout: "tree",
    ...
    if (accessIndex >= 0) {
        ...
        yield {
            ...
            entities: current,
            edges: edges.map((e) => ({ ...e })),
            description: `Found ${access} – splaying it toward the root.`,
            codeLineNumber: 2,
            layout: "tree",
            meta: { size: values.length },
        };
        ...
        yield {
            ...
            entities: splayed,
            edges: edges.map((e) => ({ ...e })),
            description: `${access} is now at the root – future accesses to it are O(1).`,
            codeLineNumber: 3,
            layout: "tree",
            meta: { size: values.length },
        };
