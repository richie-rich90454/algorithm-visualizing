...
function* run(input: unknown): Generator<VisualFrame, void, unknown> {
    const fallback: number[] = [3, 1, 2, 5, 4];
    ...
    yield {
        ...
        edges: [],
        description: "Genome blocks awaiting transposition.",
        codeLineNumber: 0,
        layout: "array",
        ...
        if (at > i) {
            ...
            if (budget > 0) {
                ...
                yield {
                    ...
                    edges: [],
                    description: `Transposing block [${want}] to position ${i}.`,
                    codeLineNumber: 2,
                    layout: "array",
                    meta: { comparisons, swaps },
                };
            ...
            if (budget > 0) {
                ...
                yield {
                    ...
                    edges: [],
                    description: `Block ${want} already home at ${i}.`,
                    codeLineNumber: 1,
                    layout: "array",
                    meta: { comparisons, swaps },
                };
